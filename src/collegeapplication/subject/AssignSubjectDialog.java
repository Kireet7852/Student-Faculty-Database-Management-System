...
public class AssignSubjectDialog extends JDialog implements ActionListener {
	...
	private AssignSubjectDialog(Faculty f) {
		...
		JLabel lblSelectSemyear = new JLabel("Semster  :");			//"Semster/Year  :"
		...
		subject = new HintTextField(" ");
		subject.setToolTipText("Subject assign");
		subject.setForeground(Color.DARK_GRAY);
		subject.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 18));
		subject.setColumns(10);
		subject.setBounds(156, 332, 338, 39);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==assignsubjectbutton)
		{
			...
			else
			{
				...
				fnew.setSubject(subject.getText()+"");
