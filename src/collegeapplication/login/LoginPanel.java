...
public class LoginPanel extends JPanel implements ActionListener
{
	...
	public LoginPanel(String loginprofile,ImageIcon imageicon,LoginPageFrame lpf) {
		...
		lblPassword.setBackground(new Color(6, 8, 94));
		lblPassword.setIcon(new ImageIcon(".\\assets\\password1.png"));
		lblPassword.setBounds(20, 272, 60, 44);
		add(lblPassword);
		lblPassword.setHorizontalAlignment(SwingConstants.CENTER);
		lblPassword.setFont(new Font("Verdana", Font.PLAIN, 18));		//new Font("Segoe UI", Font.PLAIN, 18)
		...
		useridfield.setFont(new Font("Verdana", Font.PLAIN, 18));		//new Font("Segoe UI", Font.PLAIN, 18)
		...
		lblEmailId.setBackground(new Color(6, 8, 94));
		...
		lblEmailId.setFont(new Font("Verdana", Font.PLAIN, 18));		//new Font("Segoe UI", Font.PLAIN, 18)
		
		loginbutton = new JButton("Login");
		
	
		loginbutton.setFont(new Font("Verdana", Font.BOLD, 16));		//new Font("Segoe UI", Font.BOLD, 16)
		loginbutton.setForeground(new Color(255, 255, 255));
		loginbutton.addActionListener(this);
		loginbutton.setBackground(new Color(6, 8, 94));
		...
		lblStudentLogin.setFont(new Font("Verdana", Font.BOLD, 25));		///new Font("Segoe UI", Font.BOLD, 25)
		...
		passwordfield.setFont(new Font("Verdana", Font.PLAIN, 18));			//new Font("Segoe UI", Font.PLAIN, 18)
		...
		showandhidebutton.setBounds(341, 272, 62, 44);
		  showandhidebutton.setBorder(new EmptyBorder(0, 0, 0, 0));
		    ...
		    showandhidebutton.setFont(new Font("Verdana", Font.BOLD, 15));			//new Font("Segoe UI", Font.BOLD, 15)
		    showandhidebutton.setBackground(new Color(6, 8, 94));
