...
public class AdminProfilePanel extends JPanel {
	...
	public AdminProfilePanel(AdminMain am)
	{
		...
		editdetailsbutton.setForeground(new Color(6, 8, 94));		//Color(0, 139, 139)
		...
		editlinksbutton.setForeground(new Color(6, 8, 94));			//Color(0, 139, 139)
	...
	public AdminProfilePanel() {
		...
		setLayout(null);
		panel = new JPanel();
		panel.setBackground(new Color(6, 8, 94));
		...
		headinglabel.setBackground(new Color(6, 8, 94));
