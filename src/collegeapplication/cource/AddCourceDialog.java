...
public class AddCourceDialog extends JDialog implements ActionListener
{
	...
	public AddCourceDialog() {
		...
		lblAddNewCource.setBackground(new Color(6, 8, 94));					//Color(32, 178, 170)
		...
		JLabel lblSemyear = new JLabel("Sem ");			//Sem/Year
		...
		addcourcebutton.setBackground(new Color(6, 8, 94));					//Color(32, 178, 170)
