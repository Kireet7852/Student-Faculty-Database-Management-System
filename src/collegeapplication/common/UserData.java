...
public class UserData {
	Connection con=DataBaseConnection.getConnection();
			...
			public ArrayList<User> getUserInfo(String condition)
			{
				...
				try
				{															//'Sem/Year'
					String query="select courcecode as 'Cource',semoryear as 'Sem',userid as 'Userid',logintime as 'Login Time',userprofile as 'User Profile' from users "+condition+" order by sr_no desc";
