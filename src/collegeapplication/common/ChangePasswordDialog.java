...
public class ChangePasswordDialog extends JDialog {
	...
	public ChangePasswordDialog() {
		...
		changepasswordbutton.setBackground(new Color(6, 8, 94));		//Color(32, 178, 170)
		...
		oldshowbutton.setBackground(new Color(6, 8, 94));				//Color(32, 178, 170)
		...
		newshowbutton.setBackground(new Color(6, 8, 94));				//Color(32, 178, 170)
		...
		new2showbutton.setBackground(new Color(6, 8, 94));					//Color(32, 178, 170)
