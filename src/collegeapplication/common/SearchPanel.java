...
public class SearchPanel extends JPanel implements ActionListener {
	...
	public SearchPanel() {
		...
		table.getTableHeader().setBackground(new Color(6, 8, 94));				//Color(32, 178, 170)
		...
		lblStudentManagement.setBackground(new Color(6, 8, 94));			//Color(32, 178, 170)
		...
		searchbutton.setForeground(new Color(6, 8, 94));					//Color(0, 139, 139)
	...
	public void createtablemodel()
	{
		...
		if(studentandfacultycombo.getSelectedIndex()==0)
		{																																																				///'Sem/Year'
			String defaultquery="select s.courcecode as 'Class' ,s.rollnumber as 'Roll Number',concat(s.firstname,' ',s.lastname) as 'Student Name',c.courcename as 'Cource Name',concat(c.semoryear,'-',s.semoryear) as 'Sem' from students s left join cources c on s.courcecode=c.courcecode ";
